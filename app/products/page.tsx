...
export default function ProductsPage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (factoryFilter) {
      const factoryName = typeof product.factory === 'string' 
        ? product.factory 
  ...
  const hasActiveFilters =
    activeCategory !== "الكل" || minPrice || maxPrice || brandFilter || colorFilter || sizeFilter || factoryFilter
